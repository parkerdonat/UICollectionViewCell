    ...
    @IBAction func EditAlbumPressed(sender : AnyObject) {
        ...
        if(self.navigationItem.rightBarButtonItem?.title == "Edit"){
            ...
            for item in self.collectionView!.visibleCells() as! [AlbumCell] {
                ...
                let indexpath : NSIndexPath = self.collectionView!.indexPathForCell(item as AlbumCell)!
                let cell : AlbumCell = self.collectionView!.cellForItemAtIndexPath(indexpath) as! AlbumCell
